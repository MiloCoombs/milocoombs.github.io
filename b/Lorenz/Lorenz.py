...
wheelPop = [43,47,51,53,59,37,61,41,31,29,26,23]#The number of pins on each wheel, co prime within each set of wheels (PPPPPMMXXXXX).
#this 126 digit hex value holds the config of the machine
...
4 - Reset wheels to starting position, necessary for decryption
Q - End program
